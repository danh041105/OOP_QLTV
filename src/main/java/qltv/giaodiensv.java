...
import QuanLyTKSV.taikhoansvGUI;
import javax.swing.*;
...
public class giaodiensv extends JFrame {
    ...
    public giaodiensv(String username) {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                int choice = JOptionPane.showConfirmDialog(giaodiensv.this,  "Đóng chương trình?","Xác nhận", JOptionPane.YES_NO_OPTION,   JOptionPane.QUESTION_MESSAGE  );
    ...
    private JPanel createWhiteMenuBar() {
        ...
        menuLichsumuontra.addActionListener(e -> {
            ...
            new lsmt(this.currentID, false).setVisible(true);
            this.dispose();
        });
        ...
        menuTaiKhoan.addActionListener(e -> {
            ...
            new taikhoansvGUI(userDAO.getMSV_isLogin()).doShow();
            this.dispose();
        });
        return navPanel;
    }
