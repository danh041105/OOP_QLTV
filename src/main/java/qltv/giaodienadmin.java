...
public class giaodienadmin extends JFrame {
    ...
    public giaodienadmin(String username) {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                int choice = JOptionPane.showConfirmDialog(giaodienadmin.this, "Đóng chương trình?", "Xác nhận", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
    ...
    private JPanel createWhiteMenuBar() {
        ...
        menuLichSu.addActionListener(e -> {
            this.dispose();
            new lsmt(this.currentUsername, true).setVisible(true);
        });
